        ...
        >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card/90 shadow-2xl shadow-black/80 backdrop-blur-xl">
            ...
            <div className="flex items-center justify-between border-b border-border/50 bg-muted/40 px-4 py-3 text-xs">
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-[11px] text-muted-foreground">env: demo</span>
                </div>
                ...
                <div className="hidden sm:flex items-center gap-2 text-muted-foreground font-mono text-[11px]">
                  ...
                  <span className="rounded bg-muted px-1.5 py-0.5 text-[9px] uppercase font-semibold">preview</span>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-[11px] text-muted-foreground px-2.5">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span>usr_demo_default</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="h-1 w-1 rounded-full bg-border" />
                        <span>usr_security_sample</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-4 sm:p-6 grid gap-6 lg:grid-cols-[250px_1fr]">
                ...
                <aside className="space-y-4 border-b lg:border-b-0 lg:border-r border-border/40 pb-4 lg:pb-0 lg:pr-6">
                  ...
                  <div className="space-y-2">
                    {[
                      { name: "board_deck_example.pdf", size: "1.2 MB", status: "Indexed", color: "text-emerald-400 border-emerald-400/20 bg-emerald-500/5" },
                      { name: "security_policy_sample.docx", size: "420 KB", status: "Ready", color: "text-emerald-400 border-emerald-400/20 bg-emerald-500/5" },
                      { name: "api_key_policy_example.md", size: "84 KB", status: "Cached", color: "text-blue-400 border-blue-400/20 bg-blue-500/5" },
                    ].map((file) => (
                      <div
                        key={file.name}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="max-w-[95%] rounded border border-border bg-background p-4 text-xs space-y-3 leading-relaxed">
                      ...
                      <p className="text-foreground/90">
                        Based on the uploaded <code className="font-mono bg-muted px-1 py-0.5 rounded text-[11px] text-indigo-400">board_deck_example.pdf</code>:
                      </p>
                      ...
                      <div className="mt-4 pt-3 border-t border-border/40 space-y-2">
                        ...
                        <div className="grid gap-2 sm:grid-cols-2">
                          {[
                            { name: "board_deck_example.pdf", match: "High relevance", excerpt: "...consolidated Q4 revenue reached $12.4M, representing an 18% growth quarter-over-quarter..." },
                            { name: "board_deck_example.pdf", match: "High relevance", excerpt: "...recurring growth expansion vectors were heavily anchored in enterprise client accounts..." }
                          ].map((cit, idx) => (
                            <div key={idx} className="rounded border border-border/50 bg-muted/10 p-2 font-mono text-[10px]">
                              <div className="flex items-center justify-between border-b border-border/30 pb-1 mb-1 text-[9px]">
                                <span className="text-indigo-400 font-semibold">{idx+1}. {cit.name} [document excerpt]</span>
                                <span className="text-muted-foreground">{cit.match}</span>
                              </div>
            ...
            <div className="border-t border-border/50 bg-muted/20 px-6 py-4 grid grid-cols-2 md:grid-cols-4 gap-4 font-mono">
              {[
                { label: "Representative Dataset", value: "148k chunks" },
                { label: "Storage Footprint", value: "~40 MB" },
                { label: "Typical RAG Latency", value: "~150ms" },
                { label: "Cache Efficiency", value: "Illustrative" },
              ].map((stat) => (
